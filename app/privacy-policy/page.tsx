...
export const metadata: Metadata = {
    ...
    description: 'Read the Kingdom Rush Privacy Policy. Learn how we collect, use, and protect your personal data when you use our free online game.',
    keywords: ['Kingdom Rush privacy policy', 'data protection', 'cookie policy'],
};
    ...
    return (
        <>
            ...
            <div className="page-content">
                <p>
                    At Kingdom Rush, we are committed to protecting your privacy and ensuring transparency
                ...
                <ul>
                    ...
                    <li>To protect the rights, property, or safety of Kingdom Rush, our users, or the public</li>
                </ul>

                <h2>5. Children&apos;s Privacy</h2>
                <p>
                    Kingdom Rush is designed to be family-friendly. We do not knowingly collect personal
                ...
                <p>
                    ...
                    <strong>privacy@kingdomrush.online</strong>.
                </p>
            </div>
        </>
    );
