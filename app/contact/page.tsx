...
const SUPPORT_EMAIL = 'hello@kingdomrush.online';

export const metadata: Metadata = {
    title: 'Contact Kingdom Rush',
    description: 'Get in touch with the Kingdom Rush team for support, feedback, partnerships, accessibility concerns, or privacy questions.',
    keywords: ['contact Kingdom Rush', 'Kingdom Rush support', 'game contact'],
    alternates: {
        canonical: '/contact',
    },
};
