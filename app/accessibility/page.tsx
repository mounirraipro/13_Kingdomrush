...
export const metadata: Metadata = {
    ...
    description: 'Kingdom Rush is committed to digital accessibility. Learn about our efforts to make our game available to everyone.',
    keywords: ['Kingdom Rush accessibility', 'accessible game', 'web accessibility statement'],
};
        ...
        <>
            <div className="page-header">
                <div className="container">
                    ...
                    <p>Our commitment to making Kingdom Rush accessible to everyone.</p>
                </div>
            </div>

            <div className="page-content">
                <p>
                    Kingdom Rush is committed to ensuring digital accessibility for people with disabilities.
                ...
                <p>
                    We recognize that the game component of Kingdom Rush presents additional accessibility
                ...
                <h2>Feedback</h2>
                <p>
                    We welcome your feedback on the accessibility of Kingdom Rush. If you encounter
                ...
                <ul>
                    ...
                    <li>Email: <strong>accessibility@kingdomrush.online</strong></li>
                </ul>
                <p>
