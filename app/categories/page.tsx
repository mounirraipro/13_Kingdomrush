...
export const metadata: Metadata = {
  ...
  description:
    'Browse all Kingdom Rush puzzle categories. Explore Animals, Nature, Cities, Art, and Food levels with beginner-to-expert difficulty.',
  keywords: ['puzzle categories', 'jigsaw categories', 'Kingdom Rush categories'],
  alternates: {
