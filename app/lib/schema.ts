...
const SITE_URL = 'https://kingdomrush.online';
...
export function buildWebSiteSchema() {
    return {
        ...
        name: 'Kingdom Rush',
        url: SITE_URL,
        description: 'Play Kingdom Rush free online — no download, no account needed.',
        potentialAction: {
            '@type': 'SearchAction',
            target: {
                '@type': 'EntryPoint',
...
export function buildWebApplicationSchema() {
    return {
        ...
        description:
            'A free browser-based game. Play Kingdom Rush online instantly.',
        author: {
            '@type': 'Person',
            name: AUTHOR_NAME,
            url: AUTHOR_URL,
