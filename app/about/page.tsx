...
const aboutSchema = [
    {
        ...
        '@type': 'AboutPage',
        name: 'About Kingdom Rush',
        url: 'https://kingdomrush.online/about',
        description: 'Learn about Kingdom Rush, our mission, and the team behind the game.',
        publisher: {
            '@type': 'Organization',
            name: 'Kingdom Rush',
            url: 'https://kingdomrush.online',
        },
    },
    {
        '@context': 'https://schema.org',
...
export const metadata: Metadata = {
    title: 'About Us – Kingdom Rush',
    description: 'Learn about Kingdom Rush, our mission, and the team behind the game.',
    keywords: ['about Kingdom Rush', 'game team', 'who made Kingdom Rush'],
};
        ...
        <>
            ...
            <div className="page-header">
                <div className="container">
                    <h1 className="gradient-text">About Kingdom Rush</h1>
            ...
            <div className="page-content">
                <h2>Our Story</h2>
                <p>
                    Kingdom Rush was born from a simple idea: what if playing Kingdom Rush could be even simpler and more accessible?. The result is a game
                    that&apos;s instantly intuitive yet endlessly engaging — an experience unlike any other on the web.
                </p>
                <p>
                    We launched Kingdom Rush with a clear vision — to create a free, accessible, and
                    ...
                    Kingdom Rush has something for you.
                </p>
                ...
                <p>
                    Every level in Kingdom Rush is handcrafted with care. We obsess over the details
                    so you can simply enjoy the game.
                </p>

                <h2>What Makes Us Different</h2>
                <p>
                    Kingdom Rush offers a unique experience compared to similar games in its category.
                </p>
                ...
                <p>
                    ...
                    <a href="/contact">Contact page</a>. Your input helps us make Kingdom Rush better for
                    everyone.
                </p>
            </div>
        </>
