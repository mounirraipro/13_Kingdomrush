...
export const metadata: Metadata = {
    title: 'Cookie Policy',
    description: 'Learn about the cookies Kingdom Rush uses, why we use them, and how to manage your cookie preferences.',
    keywords: ['Kingdom Rush cookies', 'cookie policy', 'cookie preferences', 'tracking cookies'],
};
    ...
    return (
        <>
            ...
            <div className="page-content">
                <p>
                    This Cookie Policy explains what cookies are, how Kingdom Rush uses them, and how you can
                ...
                <p>Kingdom Rush uses cookies for the following purposes:</p>
                ...
                <p>
                    We currently do not use any tracking or analytics cookies (such as Google Analytics) on Kingdom Rush.
                </p>
                ...
                <p>
                    ...
                    or email <strong>privacy@kingdomrush.online</strong>.
                </p>
            </div>
        </>
    );
