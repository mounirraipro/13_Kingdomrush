...
export const metadata: Metadata = {
    ...
    description: 'Read the Kingdom Rush Terms of Service. Understand the rules and guidelines for using our free online game.',
    keywords: ['Kingdom Rush terms of service', 'terms and conditions', 'usage agreement'],
};
    ...
    return (
        <>
            ...
            <div className="page-content">
                <p>
                    Welcome to Kingdom Rush. By accessing or using our website and game, you agree to be
                    bound by these Terms of Service. Please read them carefully before using our services.
                </p>

                <h2>1. Acceptance of Terms</h2>
                <p>
                    By accessing Kingdom Rush at kingdomrush.online, you acknowledge that you have read,
                ...
                <p>
                    Kingdom Rush provides a free, browser-based game. Kingdom Rush is a free, browser-based game experience.
                    The service includes the game itself, educational content, blog articles, and related resources.
                </p>

                <h2>3. User Eligibility</h2>
                <p>
                    Kingdom Rush is available to users of all ages. However, users under 13 years of age
                ...
                <p>
                    All content on Kingdom Rush — including but not limited to the game design, code, images,
                    text, graphics, logos, and audio — is the intellectual property of Kingdom Rush or its
                ...
                <p>
                    ...
                    Kingdom Rush for personal, non-commercial purposes only.
                </p>

                <h2>5. Acceptable Use</h2>
                <p>When using Kingdom Rush, you agree NOT to:</p>
                <ul>
                ...
                <p>
                    ...
                    grant Kingdom Rush a non-exclusive, royalty-free, perpetual license to use, modify,
                    and incorporate that content into our services.
                </p>

                <h2>7. Advertisements</h2>
                <p>
                    Kingdom Rush displays advertisements from third-party ad networks, including Google
                ...
                <p>
                    Kingdom Rush is provided &ldquo;as is&rdquo; and &ldquo;as available&rdquo; without warranties of any
                ...
                <p>
                    To the fullest extent permitted by law, Kingdom Rush and its operators shall not be
                ...
                <p>
                    We reserve the right to suspend or terminate your access to Kingdom Rush at our sole
                ...
                <p>
                    ...
                    <strong>legal@kingdomrush.online</strong>.
                </p>
            </div>
        </>
    );
